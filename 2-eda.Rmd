...
```{r load-data}
# Load cleaned data - FINAL EVOLUTIONS ONLY to avoid downward bias from unevolved forms
pokemon_df <- read_csv("data/pokemon_data_final_evolutions.csv")
...
# This contains FINAL EVOLUTIONS ONLY to avoid statistical bias
if (!dir.exists("data")) dir.create("data", recursive = TRUE)

write_csv(pokemon_df, "data/pokemon_data_final_evolutions_enriched.csv")

cat("\nEnriched dataset saved to: data/pokemon_data_final_evolutions_enriched.csv\n")
cat(
  "New features added:",
