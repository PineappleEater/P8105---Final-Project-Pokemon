...
<img src="../assets/sprites/gif/charizard.gif" width="90" alt="Charizard" style="display: block; margin: 0 auto 5px;">
<div style="font-weight: 600; color: #e74c3c; font-size: 0.9em;">Charizard</div>
</div>
<div style="display: inline-block; text-align: center; margin: 0 10px;">
<img src="../assets/sprites/gif/garchomp.gif" width="85" alt="Garchomp" style="display: block; margin: 0 auto 5px;">
<div style="font-weight: 600; color: #e74c3c; font-size: 0.9em;">Garchomp</div>
</div>
<div style="display: inline-block; text-align: center; margin: 0 10px;">
<img src="../assets/sprites/gif/blissey.gif" width="80" alt="Blissey" style="display: block; margin: 0 auto 5px;">
<div style="font-weight: 600; color: #3498db; font-size: 0.9em;">Blissey</div>
</div>
<div style="display: inline-block; text-align: center; margin: 0 10px;">
<img src="../assets/sprites/gif/aggron.gif" width="85" alt="Aggron" style="display: block; margin: 0 auto 5px;">
<div style="font-weight: 600; color: #3498db; font-size: 0.9em;">Aggron</div>
</div>
</div>
...
kable(top_offensive,
      caption = "Top 20 Offensive Pokémon",
      digits = 1,
      align = "lllcccc")
```
...
kable(top_defensive,
      caption = "Top 20 Defensive Pokémon",
      digits = 1,
      align = "lllcccc")
```
...
kable(top_regular,
      caption = "Top 20 Regular Pokémon (Accessible for Beginners)",
      digits = 1,
      align = "lllcccc")
```
...
<div style="text-align: center; margin: 20px 0;">
<div style="display: inline-block; text-align: center; margin: 0 10px;">
<img src="../assets/sprites/gif/pikachu.gif" width="70" alt="Pikachu" style="display: block; margin: 0 auto 5px;">
<div style="font-weight: 600; color: #f39c12; font-size: 0.9em;">Pikachu</div>
</div>
<div style="display: inline-block; text-align: center; margin: 0 10px;">
<img src="../assets/sprites/gif/eevee.gif" width="70" alt="Eevee" style="display: block; margin: 0 auto 5px;">
<div style="font-weight: 600; color: #f39c12; font-size: 0.9em;">Eevee</div>
</div>
<div style="display: inline-block; text-align: center; margin: 0 10px;">
<img src="../assets/sprites/gif/snorlax.gif" width="80" alt="Snorlax" style="display: block; margin: 0 auto 5px;">
<div style="font-weight: 600; color: #f39c12; font-size: 0.9em;">Snorlax</div>
</div>
</div>
