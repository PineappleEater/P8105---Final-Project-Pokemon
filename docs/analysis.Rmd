...
<img src="../assets/sprites/gif/alakazam.gif" width="80" alt="Alakazam" style="display: block; margin: 0 auto 5px;">
<div style="font-weight: 600; color: #667eea; font-size: 0.9em;">Alakazam</div>
</div>
<div style="display: inline-block; text-align: center; margin: 0 10px;">
<img src="../assets/sprites/gif/porygon.gif" width="80" alt="Porygon" style="display: block; margin: 0 auto 5px;">
<div style="font-weight: 600; color: #667eea; font-size: 0.9em;">Porygon</div>
</div>
<div style="display: inline-block; text-align: center; margin: 0 10px;">
<img src="../assets/sprites/gif/mewtwo.gif" width="90" alt="Mewtwo" style="display: block; margin: 0 auto 5px;">
<div style="font-weight: 600; color: #667eea; font-size: 0.9em;">Mewtwo</div>
</div>
<div style="display: inline-block; text-align: center; margin: 0 10px;">
<img src="../assets/sprites/gif/magnezone.gif" width="80" alt="Magnezone" style="display: block; margin: 0 auto 5px;">
<div style="font-weight: 600; color: #667eea; font-size: 0.9em;">Magnezone</div>
</div>
</div>
...
<div style="text-align: center; margin: 20px 0;">
<div style="display: inline-block; text-align: center; margin: 0 10px;">
<img src="../assets/sprites/gif/gengar.gif" width="70" alt="Gengar" style="display: block; margin: 0 auto 5px;">
<div style="font-weight: 600; color: #667eea; font-size: 0.9em;">Gengar</div>
</div>
<div style="display: inline-block; text-align: center; margin: 0 10px;">
<img src="../assets/sprites/gif/dragonite.gif" width="70" alt="Dragonite" style="display: block; margin: 0 auto 5px;">
<div style="font-weight: 600; color: #667eea; font-size: 0.9em;">Dragonite</div>
</div>
<div style="display: inline-block; text-align: center; margin: 0 10px;">
<img src="../assets/sprites/gif/lucario.gif" width="70" alt="Lucario" style="display: block; margin: 0 auto 5px;">
<div style="font-weight: 600; color: #667eea; font-size: 0.9em;">Lucario</div>
</div>
</div>
