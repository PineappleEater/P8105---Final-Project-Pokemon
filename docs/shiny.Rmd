...
<div style="display: inline-block; text-align: center; margin: 0 10px;">
<img src="../assets/sprites/gif/bulbasaur.gif" width="70" alt="Bulbasaur" style="display: block; margin: 0 auto 5px;">
<div style="font-weight: 600; color: #27ae60; font-size: 0.9em;">Bulbasaur</div>
</div>
<div style="display: inline-block; text-align: center; margin: 0 10px;">
<img src="../assets/sprites/gif/charmander.gif" width="70" alt="Charmander" style="display: block; margin: 0 auto 5px;">
<div style="font-weight: 600; color: #e74c3c; font-size: 0.9em;">Charmander</div>
</div>
<div style="display: inline-block; text-align: center; margin: 0 10px;">
<img src="../assets/sprites/gif/squirtle.gif" width="70" alt="Squirtle" style="display: block; margin: 0 auto 5px;">
