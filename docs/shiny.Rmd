...
<div class="hero">
  <h1>🎮 Interactive Pokémon Explorer</h1>
  <p style="font-size: 1.2em;">Explore correlations and patterns across 1,025+ Pokémon</p>
</div>
...
### Correlation Visualizations {.tabset .tabset-pills}
...
<div style="text-align: center; padding: 20px; background: #f8f9fa; border-radius: 10px;">
  <p style="color: #666;">
    💡 <b>Tip:</b> Click and drag on any chart to zoom in. Double-click to reset.
    Use the filters in the Correlation Explorer tab to interactively explore different subsets of Pokémon!
  </p>
</div>
