...
🌟 **Analysis**:
*Dragon-types* sit comfortably at the top of the BST chart—no surprise there. The type has basically become the franchise’s “stat type,” boosted every generation by at least one pseudo-legendary$^{(1)}$ line. These late-game, three-stage powerhouses (“big late bloomers”) dramatically raise the overall average for Dragons.
