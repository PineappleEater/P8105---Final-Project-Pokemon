...
write_csv(pokemon_df_final, "data/pokemon_data.csv")
...
`pokemon_df_final`: Dataset that included all 9 Generation of Pokémon states, height and weight.   
`pokemon_evolved_df`: Sub dataset `pokemon_df` for that only included **Fully Evolved Pokémon**.  
