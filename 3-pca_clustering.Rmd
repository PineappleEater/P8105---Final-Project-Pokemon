...
write_csv(pokemon_outliers, "data/pokemon_outliers.csv")

cat(glue("\nExported {nrow(pokemon_outliers)} combined outliers to 'data/pokemon_outliers.csv'\n"))
...
```{r export-results}
# Save PCA results
write_csv(pca_plot_df, "data/pokemon_pca_scores.csv")

# Save cluster assignments
cluster_export <- cluster_profile_df |>
  select(dex, name, category, cluster)
write_csv(cluster_export, "data/pokemon_clusters.csv")
