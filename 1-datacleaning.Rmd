...
### Final Pokémon dataset  
Using a list of fully evolved Pokémon from the new dataset to filter our Pokémon list for further analysis.  
Furthermore, we have created tags for all Pokémon based on their specific species and generation.
```{r, message=FALSE, warning=FALSE}
...
|-----------|---------------|-------------|----------------|
| `pokemon_data_raw.csv` | 1,218 | Raw dataset (basic stats only) | Reference |
| `pokemon_data_all.csv` | 1,218 | Complete dataset with category labels | Reference, comprehensive analysis |
